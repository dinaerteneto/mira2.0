/*! SmartAdmin - v1.4.1 - 2014-06-26 */var root = this, SpeechRecognition = root.SpeechRecognition || root.webkitSpeechRecognition || root.mozSpeechRecognition || root.msSpeechRecognition || root.oSpeechRecognition;
...
(function (a) {
    ...
    if (!SpeechRecognition)
        return root.smartSpeechRecognition = null, a;
    ...
    root.smartSpeechRecognition = {init: function (i, j) {
            ...
            for (var e in a)
                if (a.hasOwnProperty(e)) {
                    if (b = root[a[e]] || a[e], "function" != typeof b)
                        continue;
