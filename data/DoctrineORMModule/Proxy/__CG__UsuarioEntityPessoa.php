...
class Pessoa extends \Usuario\Entity\Pessoa implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Usuario\\Entity\\Pessoa' . "\0" . 'id', '' . "\0" . 'Usuario\\Entity\\Pessoa' . "\0" . 'nome', '' . "\0" . 'Usuario\\Entity\\Pessoa' . "\0" . 'dataNascimento', '' . "\0" . 'Usuario\\Entity\\Pessoa' . "\0" . 'cpf', '' . "\0" . 'Usuario\\Entity\\Pessoa' . "\0" . 'adicionadoEm', '' . "\0" . 'Usuario\\Entity\\Pessoa' . "\0" . 'alteradoEm');
        }
    ...
    public function getAdicionadoEm()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAdicionadoEm', array());

        return parent::getAdicionadoEm();
    }
    ...
    public function setAdicionadoEm()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAdicionadoEm', array());

        return parent::setAdicionadoEm();
    }
